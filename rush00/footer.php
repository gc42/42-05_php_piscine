			<!-- A INCLURE DANS LE FICHIER index.php -->
			<footer>
				<!-- BACKGROUND_BLACK -->
				<div id="foot_wrapper">
					<div id="foot_services">
						...
						<div id="services_contact">
							<h1>Contact</h1>
							<hr>
							<p><img src="./images/icones/ico_phone.png" alt="phone number" />+33 1 111111</p>
							<p><img src="./images/icones/ico_enveloppe.png" alt="Ecrivez-nous" />Écrivez-nous</p>
							<a href="magasins.html" title="Trouver un magasin"><p><img src="./images/icones/ico_pin_map.png" alt="Trouver un magasin" />Trouver un magasin</p></a>
					...
					<div id="foot_mentions">
						<div class="foot_mention_left">
							<a href="https://itunes.apple.com" title="App Store" target="blank"><img src="./images/icones/ico_app-store-badge.svg" alt="Apple store" title="Apple store"/></a>
							<a href="https://store.google.com/" title="Google Play" target="blank"><img src="./images/icones/ico_google-play-badge-v1.png" alt="Google play" title="Google play"/></a>
						...
						<div class="foot_mention_right">
							<a href="https://www.instagram.com" title="Instagram" target="blank"><img src="./images/icones/ico_instagram.png" alt="instagram" title="instagram"/></a>
							<a href="https://twitter.com" title="Tweeter" target="blank"><img src="./images/icones/ico_tweeter.png" alt="tweeter" title="tweeter"/></a>
							<a href="https://www.facebook.com/" title="Facebook" target="blank"><img src="./images/icones/ico_facebook.png" alt="facebook" title="facebook"/></a>
							<a href="https://www.pinterest.com/" title="Pinterest" target="blank"><img src="./images/icones/ico_pinterest.png" alt="pinterest" title="pinterest"/></a>
							<a href="https://www.youtube.com" title="Youtube" target="blank"><img src="./images/icones/ico_youtube.png" alt="youtube" title="youtube"/></a>
							<a href="https://plus.google.com" title="GooglePlus" target="blank"><img src="./images/icones/ico_googleplus.png" alt="googleplus" title="googleplus"/></a>
					...
					<div class="foot_gris">
						<p>&copy; 2018 Made whith<img src="./images/icones/ico_coeur_rouge.png" alt="Avec joie" title="Joie"/>by 'Les pieds de plomb'. All rights reserved.</p>
					</div>
				</div> <!-- /foot_wrapper -->
			</footer>
		</div> <!-- /site -->
